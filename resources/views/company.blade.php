@php
    $page = app()->isLocale('en')
        ? [
            ...
            'metrics' => [['24/7', 'Monitoring & support'], ['1,500+', 'User workstations'], ['30+', 'Projects delivered'], ['DRC', 'National coverage']],
        ...
        : [
            ...
            'metrics' => [['24/7', 'Supervision & support'], ['1 500+', 'Postes utilisateurs'], ['30+', 'Projets réalisés'], ['RDC', 'Couverture nationale']],
